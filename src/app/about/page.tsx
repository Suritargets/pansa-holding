        ...
        <section className="relative py-20">
          ...
          <div className="relative z-10 text-center px-6">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              ...
              <a href="tel:+5977698051" className="flex items-center gap-2 text-sm text-white hover:text-[#8fb030] transition-colors">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" style={{ color: "#8fb030" }}>
                  <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                </svg>
                Phone: (+597) 6802051 / (+597) 6802052 | Mobile: (+597) 7698051 / (+597) 7698050
              </a>
            </div>
          </div>
        </section>
