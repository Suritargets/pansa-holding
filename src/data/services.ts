...
export const services: Service[] = [
  ...
  },
  {
    ...
    image: `${BASE}s7.jpg`,
    intro: "Quality technical vocational training and demand-driven programs according to (ASME, AWS, API, NIL, SBB, CANTA-CVQ, VCA)\n\nPANSA GROUP OF COMPANIES N.V. is dedicated to bridging the skills gap and empowering individuals with the technical expertise needed for success in today's dynamic industries. Our Technical Vocational Training & Qualification programs are crafted to provide hands-on, practical training that aligns with industry requirements, ensuring that participants are equipped with the skills essential for a thriving career.",
    bullets: [
      "OHSEQ Training programs",
      "ISO Training programs",
      "Welding, Machinist, Mechanical- and Electrical Maintenance training programs",
    ],
    sections: [
      { heading: "Comprehensive Training Programs", text: "Our Technical Vocational Training covers a wide spectrum of disciplines, including but not limited to engineering, mechanics, welding, and instrumentation. Through a combination of classroom instruction and hands-on practical experience, participants gain a deep understanding of industry-specific techniques and best practices." },
      { heading: "Industry-Relevant Curriculum", text: "PANSA GROUP OF COMPANIES N.V. collaborates closely with industry experts to develop training curricula that are both relevant and responsive to the evolving needs of the workforce. Our programs incorporate the latest technologies, tools, and methodologies, ensuring that participants are well-prepared for the challenges of modern workplaces." },
      { heading: "Experienced Instructors", text: "Our training programs are led by seasoned instructors with extensive industry experience. They bring real-world insights into the classroom, providing not only theoretical knowledge but practical wisdom that enhances the learning experience. This mentorship approach ensures that participants receive guidance from professionals who understand the intricacies of the field." },
      { heading: "Qualification and Certification", text: "PANSA GROUP OF COMPANIES N.V. is committed to ensuring that participants not only acquire skills but also receive recognized qualifications. Our training programs are designed to align with industry standards and certifications, enhancing the employability and career prospects of participants upon completion." },
      { heading: "Customized Training Solutions", text: "Recognizing the diverse needs of our clients, PANSA GROUP OF COMPANIES N.V. offers customized training solutions. Whether you are a corporate entity seeking to upskill your workforce or an individual looking to enhance your technical proficiency, our flexible training programs can be tailored to meet specific requirements." },
      { heading: "Job Placement Assistance", text: "Our commitment to the success of our participants extends beyond training. PANSA GROUP OF COMPANIES N.V. provides job placement assistance, connecting qualified individuals with employment opportunities within our extensive network of industry partners. Our goal is to facilitate a smooth transition from training to a fulfilling and rewarding career." },
      { heading: "Continuous Learning and Development", text: "In the rapidly evolving landscape of technology and industry, continuous learning is key. PANSA GROUP OF COMPANIES N.V. encourages a culture of lifelong learning by offering ongoing professional development opportunities, ensuring that individuals stay abreast of industry trends and advancements throughout their careers." },
    ],
  },
  {
    ...
    image: `${BASE}s8.jpg`,
    intro: "Pansa Group of Companies is committed to work according to the Occupational Health Safety, Environment & Quality standards, policies and regulations. Injuries occurring during our work are preventable when the work is well planned and safety policies and rules are followed.\n\nAt PANSA GROUP OF COMPANIES N.V., we recognize that a commitment to Occupational Health Safety, Environment & Quality (OHSEQ) is not only a legal and ethical obligation but a fundamental aspect of sustainable business practices. Our comprehensive OHSEQ solutions are designed to safeguard your workforce, protect the environment, and ensure compliance with the highest industry standards.",
    bullets: [
      "OHSEQ policy implementation and management",
    ...
    sections: [
      { heading: "Occupational Health and Safety", text: "Prioritizing the well-being of your workforce is paramount. PANSA GROUP OF COMPANIES N.V. provides tailored Occupational Health and Safety programs that go beyond compliance. From risk assessments to safety training and emergency response planning, our OHSEQ experts work collaboratively with your team to create a secure and healthy work environment." },
      { heading: "Environmental Sustainability", text: "Our commitment to environmental stewardship is evident in every aspect of our operations. PANSA GROUP OF COMPANIES N.V. integrates sustainable practices into our OHSEQ solutions, helping clients minimize their environmental footprint. From waste reduction strategies to energy-efficient processes, we aim to contribute to a cleaner, greener future." },
      { heading: "Regulatory Compliance", text: "Navigating the complex landscape of Occupational Health Safety, Environment & Quality regulations can be challenging. PANSA GROUP OF COMPANIES N.V. stays abreast of the latest legal requirements, ensuring that your operations align with local and international standards. Our OHSEQ consultants work to mitigate risks, avoid penalties, and promote a culture of compliance within your organization." },
      { heading: "OHSEQ Training and Awareness", text: "Empower your workforce with the knowledge and skills needed to maintain a safe and environmentally conscious workplace. PANSA GROUP OF COMPANIES N.V. offers comprehensive OHSEQ training programs, covering topics such as hazard identification, emergency response, and sustainable practices. Investing in employee awareness enhances overall safety and contributes to a culture of responsibility." },
      ...
      { heading: "OHSEQ Audits and Assessments", text: "Regular assessments are essential to maintaining the effectiveness of OHSEQ programs. PANSA GROUP OF COMPANIES N.V. conducts thorough OHSEQ audits to evaluate the performance of existing systems, identify areas for improvement, and ensure ongoing compliance. Our assessments provide valuable insights for optimizing OHSEQ strategies and enhancing overall organizational resilience." },
    ],
  },
  {
  ...
  },
  {
    ...
    bullets: [
      ...
      "OHSEQ compliance throughout all project phases",
    ],
    sections: [
      ...
      { heading: "Occupational Health Safety, Environment & Quality Compliance", text: "Safety is paramount in every aspect of our EPCM services. Pansa Group of Companies N.V. prioritizes the well-being of our personnel and the environment through rigorous safety protocols and compliance with industry standards. Our commitment to OHSEQ extends to every phase of the project, contributing to a culture of safety and sustainability." },
  ...
  },
  {
    ...
    image: `${BASE}s4.jpeg`,
    intro: "PANSA GROUP OF COMPANIES N.V. is your trusted partner for precision and reliability when it comes to Valve & Pump Maintenance and Machine Shop Works. With a wealth of experience and a commitment to excellence, we offer comprehensive solutions to ensure the optimal performance and longevity of your critical industrial equipment.",
    bullets: [
      "Control, butterfly, ball, plug and clarkson valves revision, pressure relief valves, testing and repairs of parts",
      "CNC turning, NC milling, drilling, boring",
    ],
    sections: [
      { heading: "Valve & Pump Maintenance", text: "Maintaining the integrity of valves and pumps is essential for the smooth operation of your industrial processes. PANSA GROUP OF COMPANIES N.V. specializes in meticulous valve and pump maintenance, addressing issues such as leaks, wear, and corrosion. Our certified technicians conduct thorough inspections, implement preventive measures, and execute timely repairs to maximize efficiency and minimize downtime." },
      { heading: "Machine Shop Works", text: "Our state-of-the-art machine shop is equipped with cutting-edge technology and staffed by skilled machinists. PANSA GROUP OF COMPANIES N.V. offers a wide range of machine shop services, including precision machining, fabrication, and component repair. From custom parts manufacturing to equipment modification, our machine shop works are tailored to meet the unique specifications of your projects." },
      { heading: "Overhaul and Refurbishment", text: "Extend the lifespan of your valves, pumps, and industrial machinery through our comprehensive overhaul and refurbishment services. PANSA GROUP OF COMPANIES N.V. employs a systematic approach to disassembly, inspection, and reassembly, ensuring that your equipment operates at peak performance levels. Our commitment to quality craftsmanship guarantees reliable and efficient results." },
      { heading: "Performance Optimization", text: "Efficiency and reliability are at the core of our services. PANSA GROUP OF COMPANIES N.V. goes beyond routine maintenance to optimize the performance of your valves, pumps, and machinery. Through precision tuning, component upgrades, and advanced diagnostics, we enhance the efficiency of your equipment, contributing to overall operational excellence." },
      { heading: "Emergency Repairs", text: "Minimize downtime and mitigate the impact of unexpected failures with our 24/7 emergency repair services. PANSA GROUP OF COMPANIES N.V. understands the critical nature of industrial equipment, and our rapid response team is ready to address urgent repairs, ensuring that your operations resume swiftly and smoothly." },
      { heading: "Quality Assurance", text: "Our commitment to quality is unwavering. PANSA GROUP OF COMPANIES N.V. adheres to stringent quality assurance processes throughout all stages of valve and pump maintenance and machine shop works. We prioritize precision, durability, and compliance with industry standards to deliver results that exceed expectations." },
      { heading: "Environmental Responsibility", text: "PANSA GROUP OF COMPANIES N.V. integrates environmentally responsible practices into our maintenance and machine shop operations. From waste reduction initiatives to the use of eco-friendly materials, we strive to minimize the environmental impact of our services, contributing to a sustainable and responsible industrial ecosystem." },
    ],
  },
];
